...
const PropertyCard = ({property: {featuredImage, _id, title_en, title_ar, shortDescription_en, shortDescription_ar, minPrice, plans}, language: {lang, currency}}) => {
        ...
        <div className="card shadow mb-4 animated animatedFadeInUp fadeInUp">
          ...
          <div className="card-body">
            ...
            <div className="row justify-content-start mt-3">
              <div className="col">
                <small className="text-dark">bedrooms</small>
              ...
              <div className="col">
                <small className="text-dark">bathrooms</small>
                <div className="row justify-content-start">
                  <div className='col-1'>
              ...
              <div className="col">
                <small className="text-dark">area</small>
                <div className="row justify-content-start">
                  <div className='col-1'>
            ...
            <span className="start-form">Start From: </span>
